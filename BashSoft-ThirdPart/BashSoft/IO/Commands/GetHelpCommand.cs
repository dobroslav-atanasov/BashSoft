namespace BashSoft.IO.Commands
{
    ...
    public class GetHelpCommand : Command
    {
        ...
        private void DisplayHelp()
        {
            ...
            OutputWriter.DisplayHelpMessage(string.Format("|{0, -108}|",
                "                          open file - open {path}"));
            OutputWriter.DisplayHelpMessage(string.Format("|{0, -108}|",
            ...
            OutputWriter.DisplayHelpMessage(string.Format("|{0, -108}|",
                "          change directory relative - cdrel {relative path}"));
            OutputWriter.DisplayHelpMessage(string.Format("|{0, -108}|",
                "          change directory absolute - cdabs {absolute path}"));
            OutputWriter.DisplayHelpMessage(string.Format("|{0, -108}|",
            ...
            OutputWriter.DisplayHelpMessage(string.Format("|{0, -108}|",
                "          filter students by course - filter {courseName} {excelent/average/poor} {take} {2/5/all}"));
            OutputWriter.DisplayHelpMessage(string.Format("|{0, -108}|",
                "           order students in course - order {courseName} {ascending/descending} {take} {20/10/all}"));
            OutputWriter.DisplayHelpMessage(
                string.Format("|{0, -108}|", "                      drop database - dropdb"));
